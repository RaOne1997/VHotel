...
namespace MakeMuTrip.Migrations
{
    ...
    [Migration("20220919155223_userid datatype change")]
    partial class useriddatatypechange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vhotel.DataAccess.Model.Master.Account", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("staticclassmodel.DataAccess.Model.Masters.Customer", b =>
                {
                    b.HasOne("Vhotel.DataAccess.Model.Master.Account", "account")
                        .WithMany()
            ...
            modelBuilder.Entity("staticclassmodel.DataAccess.Model.TransactionData.FlightBooking", b =>
                {
                    b.HasOne("VHotel.DataAccess.Model.Master.User", "Accounts")
                        .WithMany()
                        .HasForeignKey("AccountRefID");
            ...
            modelBuilder.Entity("staticclassmodel.DataAccess.Model.TransactionData.FlightCustomerDetail", b =>
                {
                    b.HasOne("Vhotel.DataAccess.Model.TransactionData.Customerinformation", "customer")
                        .WithMany()
